...
- **Data Analysis:** Proficient in extracting actionable insights from complex datasets through statistical methods and exploratory data analysis (EDA) to drive business insights
- **Data Visualization:** skilled in creating clear, intuitive-designed charts, dashboards, and storytelling visuals that enable quick understanding by technical and non-technical audiences
- **SQL & Database Management:** Query and relational database design (ERDs) management of large-scale datasets using SQL and Power Query for data extraction, transformation, and analysis
- **Machine Learning:** Experienced in building, training, tuning and deploying supervised/unsupervised predictive models (e.g., regression, classification, clustering) to to solve real-world business problems
